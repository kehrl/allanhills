...
- Processed ice-penetrating radar data (`track1_all.mat`, `track2_all.mat`, `track3_all.mat`, `track4_all.mat`, `crosstracks.mat`, `BIT58_2.mat`) is available at the [US Antarctic Program Data Center](http://www.usap-dc.org/view/dataset/601005) and is needed for plotting
