function [legend_h,object_h,plot_h,text_strings] = columnlegend(numcolumns, h, str, varargin)
%
...
if legend_h == false,
    %create the legend
    [legend_h,object_h,plot_h,text_strings] = legend(h,str);
end
...
%     set(legend_h, 'units', 'normalized');
    ...
    a = annotation('rectangle',pos, 'linewidth', 1,'color','k','facecolor','w');
    uistack(a,'down')
    uistack(legend_h,'up')
end
